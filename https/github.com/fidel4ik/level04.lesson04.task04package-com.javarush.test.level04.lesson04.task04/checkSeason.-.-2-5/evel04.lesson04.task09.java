...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        String ntime = reader.readLine();
        double time = Double.parseDouble(ntime);
        double minute = time % 5;
        if (1 <= minute && minute < 3)
            System.out.println("зеленый");
        else if (3 <= minute && minute < 4)
            System.out.println("желтый");
        else if (4 <= minute && minute < 5)
